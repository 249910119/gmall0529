...
public class SpuInfoServiceImpl implements SpuInfoService {
    ...
    public List<SpuInfo> getSpuInfoByC3Id(Integer catalog3Id) {
        List<SpuInfo> spuInfos = spuInfoMapper.selectList(new QueryWrapper<SpuInfo>().eq("catalog3_id", catalog3Id));
        return spuInfos;
    }
    ...
    public void saveBigSpuInfo(SpuInfo spuInfo) {
        ...
        for (SpuSaleAttr spuSaleAttr : spuSaleAttrs) {
            ...
            //4、保存销售属性值的信息
            List<SpuSaleAttrValue> saleAttrValues = spuSaleAttr.getSpuSaleAttrValues();
